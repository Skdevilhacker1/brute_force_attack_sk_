...
#ROOT PRIVILEGIES
#if [[ $EUID -ne 0 ]]; then
       echo -e "$red by Sk Devil tech |Sufiyan khan$nc"
#        exit 1
#fi
#Installation
sleep 1
...
#echo -e "	[+]              $Make by sk devil tech | Sufiyan khan$nc         		   [+]"
#echo -e "	[+] 		 $whatsapp number +919696859150 $nc 		   [+]"
#echo -e "	[+] 		 $Sk devil Tech Greetz To All Pentesters$nc          		   [+]"
#echo -e "	[+]$red Special Greetz To$nc :$green {thelinuxchoice , Ha3MrX, Tunisian Eagles, Sufiyan}$nc [+]"
echo ""
